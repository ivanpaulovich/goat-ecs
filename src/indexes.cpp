...
namespace goat {
bool Indexes::isEntitySignatureInQuery(const unsigned int signature,
                                       const unsigned int query) {
  return (signature & query) == query;
}

void Indexes::addEntityToIndex(const unsigned int id,
                               const unsigned int query) {
  m_indexes[query].insert(id);
}

void Indexes::removeEntityFromIndex(const unsigned int id,
                                    const unsigned int query) {
  m_indexes[query].erase(id);
}

void Indexes::insertOrRemoveEntityFromIndex(const unsigned int id,
...
void Indexes::removeQuery(const unsigned int query) { m_indexes.erase(query); }

std::set<unsigned int> *Indexes::getIndex(const unsigned int query) {
  return &m_indexes[query];
}

void Indexes::updateEntityIndex(const unsigned int id,
                                const unsigned int signature) {
